...
namespace DisprzTraining.Data
{
    public static class AppointmentsStore
    {
        ...
        new Appointment {Id=new Guid("9245fe4a-d402-451c-b9ed-9c1a04247481"), Description = "kkk", Title = "sss", StartTime = new DateTime(2021, 10, 10, 10, 10, 10), EndTime = new DateTime(2021, 10, 10, 12, 10, 10) }, new Appointment {Id=new Guid("9245fe4a-d402-451c-b9ed-9c1a04247471"), Description = "kkk", Title = "sss", StartTime = DateTime.UtcNow.AddYears(1), EndTime = DateTime.UtcNow.AddYears(1).AddHours(2)}};
